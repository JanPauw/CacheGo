...
public class GetPathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
    ...
    public GetPathFromLocation(LatLng source, LatLng destination, DirectionPointListener resultCallback, String API_KEY) {
        this.source = source;
    ...
    public String getUrl(LatLng origin, LatLng dest) {
        ...
        String output = "json";
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&mode=walking" + "&key=" + API_KEY;
        Log.d(TAG, "GOOGLE_JSON" + url);

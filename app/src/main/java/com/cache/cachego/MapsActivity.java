...
import static com.cache.cachego.R.color.blue;
import static com.cache.cachego.R.color.green;
import static com.cache.cachego.R.color.yellow;
...
import com.cache.cachego.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerClickListener {
    ...
    private void SetActiveNavBarColor(int index) {
        binding.navAccount.setBackgroundColor(getResources().getColor(R.color.yellow));
        binding.navMap.setBackgroundColor(getResources().getColor(R.color.yellow));
        binding.navSettings.setBackgroundColor(getResources().getColor(R.color.yellow));

        switch (index) {
            case 0:
                binding.navAccount.setBackgroundColor(getResources().getColor(R.color.green));
                break;
            case 1:
                binding.navMap.setBackgroundColor(getResources().getColor(R.color.blue));
                break;
            case 2:
                binding.navSettings.setBackgroundColor(getResources().getColor(R.color.green));
                break;
        }
    }

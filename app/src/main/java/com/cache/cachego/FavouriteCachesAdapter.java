...
public class FavouriteCachesAdapter extends ArrayAdapter<Cache> {
    public FavouriteCachesAdapter(@NonNull Context context, ArrayList<Cache> alFaveCaches)
    {
        super(context, 0, alFaveCaches);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        cvItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sf.setPreviousFragment(new FavouriteCachesFragment());
